...
@section('content')
    <h1 style="text-align: center">Formulaire de Démenagement
    </h1>
    @if (session('success'))
    ...
    <form action="{{route('demenagement.store')}}" method="post">
        ...
        <div class="form-group">
            ...
            <input name="provenance" type="text" class="form-control" id="provenance" placeholder="Entrez votre ancien lieu de residence">
        </div>
        <div class="form-group">
